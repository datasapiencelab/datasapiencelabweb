...
const projectImage01 = "https://images.unsplash.com/photo-1551434678-e076c223a692?w=800&q=80";
const projectImage02 = "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=800&q=80";
const projectImage03 = "https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=800&q=80";
const projectImage04 = "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=1200&q=80";

// Carl character SVG
const carlCharacter = "assets/images/Carl.svg";
...
function ProjectTag({ children }: ProjectTagProps) {
    return (
        <div className="flex items-center gap-1.5 sm:gap-4">
            ...
            <span className="text-xs leading-5 sm:text-base sm:leading-6 tracking-[0.5px] text-neutral-tertiary font-['Geist']">{children}</span>
        </div>
    );
}
...
function ProjectCard({ title, tags, image, className = "" }: ProjectCardProps) {
    return (
        <div className={`bg-white border border-zinc-200 p-3 sm:p-5 flex flex-col gap-3 sm:gap-5 ${className}`}>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 items-start sm:items-end">
                <div className="flex-1 flex flex-col gap-1">
                    <h3 className="font-semibold text-lg leading-7 sm:font-medium sm:text-2xl sm:leading-9 text-zinc-800 tracking-[0.5px] sm:tracking-[-0.25px] font-['Geist']">{title}</h3>
                ...
                <button className="border border-brand-primary border-solid px-3 py-2 sm:px-[18px] sm:py-3 flex gap-1 sm:gap-1.5 items-center self-start sm:self-auto">
                    <span className="text-brand-primary text-sm leading-5 sm:text-base sm:leading-6 font-semibold tracking-[0.5px] font-['Geist']">View Details</span>
                    <div className="w-4 h-4 sm:w-5 sm:h-5 relative">
                        <svg className="w-full h-full" viewBox="0 0 20 20" fill="none">
                            <path d="m8 6 4 4-4 4" stroke="#f2500d" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>
                    </div>
                </button>
            </div>
            ...
            <div className="max-w-[1280px] mx-auto flex flex-col gap-8 sm:gap-12 lg:gap-16">
                ...
                <div className="w-full flex flex-col gap-4 sm:gap-8 lg:gap-12">
                    ...
                    <div className="block sm:hidden">
                        ...
                        <div className="flex gap-1.5 items-center justify-center mb-3">
                            ...
                            <span className="text-xs leading-5 text-zinc-900 tracking-[0.5px] font-['Geist']">Our Work in Action</span>
                        </div>
                    ...
                    <div className="hidden sm:flex sm:flex-col">
                        ...
                        <div className="w-full flex justify-end mb-4">
                            <div className="flex gap-2.5 items-center">
                                ...
                                <span className="text-base lg:text-lg leading-6 lg:leading-7 text-zinc-900 tracking-[0.5px] font-['Geist']">Our Work in Action</span>
                            </div>
                        </div>
                ...
                <div className="w-full">
                    ...
                    <div className="block sm:hidden">
                        <p className="font-medium text-base leading-6 text-[#9f9fa9] tracking-[0.5px] font-['Geist'] text-center">
                            From predictive models to scalable platforms, <span className="text-zinc-900">Every solution is Fueled by Data Intelligence, Shaped by Design, and Built to deliver measurable impact.</span> See how we've helped businesses turn raw data into powerful outcomes.
                        </p>
                    </div>
                    ...
                    <div className="hidden sm:grid sm:grid-cols-3 gap-6 lg:gap-8 items-start">
                        <div className="flex gap-2.5 items-center">
                            <span className="text-2xl lg:text-[32px] leading-8 lg:leading-9 text-zinc-800 tracking-[-1px] font-['Engagement']">(2025)</span>
                        </div>
                ...
                <div className="w-full">
                    ...
                    <div className="hidden sm:grid sm:grid-cols-2 gap-6 lg:gap-8 auto-rows-max">
                        ...
                        <div className="col-span-2 bg-white border border-zinc-200 p-3 sm:p-5 flex flex-col gap-3 sm:gap-5">
                            ...
                            <div className="flex flex-col sm:flex-row gap-2 sm:gap-6 items-start sm:items-end">
                                <div className="flex-1 flex flex-col gap-1">
                                    <h3 className="font-semibold text-lg leading-7 sm:font-medium sm:text-2xl sm:leading-9 text-zinc-800 tracking-[0.5px] sm:tracking-[-0.25px] font-['Geist']">{projects[4].title}</h3>
                                    <div className="flex flex-wrap gap-2 sm:gap-4 py-1">
                ...
                <div className="flex justify-center">
                    <button className="bg-brand-primary px-4 py-2.5 sm:px-[18px] sm:py-3 flex gap-1.5 items-center w-full sm:w-auto">
                        <span className="text-white text-base leading-6 font-semibold tracking-[0.5px] font-['Geist']">View All Projects</span>
                        <div className="w-5 h-5 relative">
                            <svg className="w-full h-full" viewBox="0 0 20 20" fill="none">
                                <path d="m8 6 4 4-4 4" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                        </div>
                    </button>
                </div>
