                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-16">
                    ...
                    <div className="flex-1 flex flex-col gap-6 sm:gap-8">
                        <div className="flex flex-col gap-0">
                            <h2 className="font-semibold text-lg leading-8 sm:text-xl sm:leading-7 lg:text-2xl lg:leading-9 text-neutral-primary tracking-[-0.25px] sm:tracking-[-0.5px] font-['Geist']">
                                {title}
                            </h2>
                        </div>
