...
const menuDefaultSvg = "assets/images/Menu_expanded.svg";
...
export default function Navigation({ onMenuToggle, isMenuOpen = false }: NavigationProps) {
    return (
        <nav className="flex items-center justify-between py-4 md:py-6">
            ...
            <div className="flex items-center gap-4 md:gap-8 lg:gap-16">
                <div className="hidden md:flex items-center gap-8 lg:gap-16">
                    <a href="#home" className="text-white hover:text-zinc-300 transition-colors text-sm lg:text-base">
                        Home
                    </a>
                    <a href="#about" className="text-white hover:text-zinc-300 transition-colors text-sm lg:text-base">
                        About
                    </a>
                    <a href="#services" className="text-white hover:text-zinc-300 transition-colors text-sm lg:text-base">
                        Services
                    </a>
                </div>
